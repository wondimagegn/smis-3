                                                                ...
                                                                if ($role_id == ROLE_DEPARTMENT || $role_id == ROLE_COLLEGE) { 
                                                                    if ($vc['Student']['max_load'] == 0) { 
                                                                        ...
                                                                        <td class="center">
                                                                            ...
                                                                            <?= $this->Form->input('CourseAdd.' . $count . '.reason', array('placeholder'=> 'Your reason here....', 'size' => '2', 'rows' => '2', 'value' => isset($this->request->data['CourseAdd'][$count]['reason']) ? $this->request->data['CourseAdd'][$count]['reason'] : '', 'label' => false, 'size' => 4, 'div' => false)); ?>
