						...
						if (!empty($exemptedCourseLists)) {
							...
							foreach ($exemptedCourseLists as $bk => $bv) { ?>
								<tr id='CourseExemption_<?= $count; ?>'>
									...
									<td class="center">
										<?= $this->Form->input('CourseExemption.' . $bkc . '.taken_course_title', array('value' => (isset($bv['CourseExemption']['taken_course_title']) ? $bv['CourseExemption']['taken_course_title'] : ''), 'id' => 'takenCourseTitle_' . $count .'', 'label' => false, 'div' => false, 'required')); ?>
										<?= $this->Form->hidden('CourseExemption.' . $bkc . '.id', array('value' => $bv['CourseExemption']['id'])); ?>
									</td>
									<td class="center"><?= $this->Form->input('CourseExemption.' . $bkc . '.taken_course_code', array('value' => (isset($bv['CourseExemption']['taken_course_code']) ? $bv['CourseExemption']['taken_course_code'] : ''), 'id' => 'takenCourseCode_' . $count .'', 'label' => false, 'div' => false, 'pattern' => '^[A-Z][a-zA-Z]{1,3}-\\d{3,4}$', 'title' => 'Ensure the Course code starts with a Capital letter followed by 1 to 3 letters, then a hyphen and 3 to 4 digits(numbers)', 'required')); ?></td>
									<td class="center"><?= $this->Form->input('CourseExemption.' . $bkc . '.course_taken_credit', array('value' => (isset($bv['CourseExemption']['course_taken_credit']) ? $bv['CourseExemption']['course_taken_credit'] : ''), 'id' => 'courseTakenCredit_' . $count .'', 'label' => false, 'div' => false, 'type' => 'number', 'min' => 0, 'max' => 15, 'required')); ?></td>
									...
									<td class="center"><?= $this->Form->input('CourseExemption.' . $bkc . '.course_id', array('options' => $coursesForList, 'type' => 'select', 'label' => false, 'id' => 'course_id_' . $count .'', 'default' => (isset($bv['CourseExemption']['course_id']) ? $bv['CourseExemption']['course_id'] : ''), 'style' => 'width: 100%;', 'onchange' => 'updateCourseDetailsOnChange(this)', 'required')); ?></td>
									<td class="center"><?= $this->Form->input('CourseExemption.' . $bkc . '.grade', array('options' => $grades, 'type' => 'select', 'label' => false, 'id' => 'grade_' . $count .'', 'empty' => '[ Select ]', 'default' => (isset($bv['CourseExemption']['grade']) ? $bv['CourseExemption']['grade'] : ''), 'required')); ?></td>
							...
							<tr id='CourseExemption_1'>
								<td class="center">1</td><td><?= $this->Form->input('CourseExemption.0.taken_course_title', array('value' => (isset($this->request->data['CourseExemption'][0]['taken_course_title']) ? $this->request->data['CourseExemption'][0]['taken_course_title'] : ''), 'id' => "takenCourseTitle_1", 'label' => false, 'required')); ?></td>
								<td class="center"><?= $this->Form->input('CourseExemption.0.taken_course_code', array('value' => (isset($this->request->data['CourseExemption'][0]['taken_course_code']) ? $this->request->data['CourseExemption'][0]['taken_course_code'] : ''), 'id' => "takenCourseCode_1", 'label' => false, 'pattern' => '^[A-Z][a-zA-Z]{1,3}-\\d{3,4}$', 'title' => 'Ensure the Course code starts with a Capital letter followed by 1 to 3 letters, then a hyphen and 3 to 4 digits(numbers)', 'required')); ?></td>
								<td class="center"><?= $this->Form->input('CourseExemption.0.course_taken_credit', array('value' => (isset($this->request->data['CourseExemption'][0]['course_taken_credit']) ? $this->request->data['CourseExemption'][0]['course_taken_credit'] : ''), 'id' => "courseTakenCredit_1", 'label' => false, 'type' => 'number', 'min' => 0, 'max' => 15, 'required' )); ?></td>
								<td class="center"><?= $this->Form->input('CourseExemption.0.course_id', array('options' => $courses, 'type' => 'select', 'label' => false, 'default' => (isset($this->request->data['CourseExemption'][0]['course_id']) ? $this->request->data['CourseExemption'][0]['course_id'] : ''), 'id' => "course_id_1", 'required', 'style' => 'width: 100%;', 'onchange' => 'updateCourseDetailsOnChange(this)')); ?></td>
								<td class="center"><?= $this->Form->input('CourseExemption.0.grade', array('options' => $grades, 'type' => 'select', 'label' => false, 'empty' => '[ Select ]', 'default' => (isset($this->request->data['CourseExemption'][0]['grade']) ? $this->request->data['CourseExemption'][0]['grade'] : ''), 'id' => "grade_1", 'required')); ?></td>
