		...
		<div class="box-body pad-forty">
			<div class="row">
				<div class="large-12 columns">
					...
					<div class="tabs-content edumix-tab-horz">
						...
						<div class="content" id="education_background">
							...
							<div class="row">
								...
								if (($this->Session->read('Auth.User')['role_id'] == ROLE_STUDENT && ($studentDetail['Program']['id'] == PROGRAM_UNDEGRADUATE /* || $studentDetail['Program']['id'] == PROGRAM_POST_GRADUATE */)) || (isset($this->data['EheeceResult'][0]['subject']) && !empty($this->data['EheeceResult'][0]['subject']))) { 
												...
												<tbody>
													...
													if (!empty($this->data['EheeceResult'])) {
														...
														foreach ($this->data['EheeceResult'] as $bk => $bv) {
															...
															<tr>
																<td class="center"><?= ++$count; ?></td>
																<td class="center"><?= $this->Form->input('EheeceResult.' . $bk . '.subject', array('name' => "data[EheeceResult][$bk][subject]", 'value' => isset($this->data['EheeceResult'][$bk]['subject']) ? $this->data['EheeceResult'][$bk]['subject'] : '', 'style' => 'width:100%;', 'pattern' => 'alpha', 'placeholder' => 'Subject 1', 'label' => false)); ?></td>
																<td class="center"><?= $this->Form->input('EheeceResult.' . $bk . '.mark', array('name' => "data[EheeceResult][$bk][mark]", 'value' => isset($this->data['EheeceResult'][$bk]['mark']) ? $this->data['EheeceResult'][$bk]['mark'] : '',  'style' => 'width:100%;', 'placeholder' => 'Mark 1', 'label' => false, 'min' => '0', 'max' => '100', 'step' => 'any')); ?></td>
					...
					<?= '<hr>'. $this->Form->end(array('label' => 'Update Student Detail', /* 'disabled', */ 'name' => 'updateStudentDetail', 'id' => 'SubmitID', 'class' => 'tiny radius button bg-blue')); ?>
