			...
			<div class="large-12 columns">
				...
				<div class="courseDrops form">
					...
					<blockquote>
						...
						<span style="text-align:justify;" class="fs15 text-gray">This tool will help you to perform course drop on behalf of students for selected academic year and semester.</span>
					</blockquote>
					<hr>
