...
if ($view_only) { ?>
	<hr>
	<div id="flashMessage" class="warning-box warning-message fs15" style="font-family: 'Times New Roman', Times, serif;"><span style="margin-right: 15px;"></span>To manage this published course exam result and grade, <?= isset($course_assignment_detail[0]) && !empty($course_assignment_detail[0]) ? ' ' . $course_assignment_detail[0]['Staff']['full_name'] . '\'s' : 'the assigned instructor\'s'; ?>  account should be closed/deactivated by the system administrator. To achieve this, you can request a user account deactivation request for your staffs that are on study leave or left the university permanentyly in <a href="/users/deactivate_account/2" target="_blank">Deactivate User Account</a>.</div>
	<hr>
	<?php
}
