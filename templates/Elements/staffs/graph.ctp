...
if (isset($distributionStatistics['graph']) && !empty($distributionStatistics['graph'])) { ?>
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<canvas id="<?php echo $this->data['Staff']['graph_type']; ?>" class="chart chart-<?php echo $this->data['Staff']['graph_type'] ?>" chart-data="data" chart-series="series" chart-labels="labels" chart-colors="colors" chart-options="options">
...
if (isset($distributionStatisticsStatus['graph']) && !empty($distributionStatisticsStatus['graph'])) { ?>
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<canvas id="<?php echo $this->data['Report']['graph_type']; ?>" class="chart chart-<?php echo $this->data['Report']['graph_type'] ?>" chart-data="data" chart-series="series" chart-labels="labels" chart-colors="colors" chart-options="options">
