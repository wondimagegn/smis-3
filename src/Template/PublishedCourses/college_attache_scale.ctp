...
<div class="box">
    <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                <?= $this->Form->create('PublishedCourse', ['url' => ['controller' => 'PublishedCourses', 'action' => 'collegeAttachScale']]) ?>
                        ...
                        <tr>
                            <td>
                                <?= $this->Form->control('academic_year', [
                                    ...
                                    'default' => $this->request->getData('PublishedCourse.academic_year',
                                        $defaultacademicyear)
                                ]) ?>
                            </td>
                            <td>
                ...
                <?php if (isset($section_organized_published_courses) && !empty($section_organized_published_courses) && isset($gradeScales) && !empty($gradeScales)): ?>
                <div>
                    <h2><?= __('Select scale you want to attach for the given course.') ?></h2>
                    <table class="table table-bordered">
                        <?php $count = 0; $hide_button = 0; ?>
                        <?php foreach ($section_organized_published_courses as $section_name => $sectioned_published_courses): ?>
                        <tr>
                            <td colspan="7"><h3><?= __('Section: %s', h($section_name)) ?></h3></td>
                        </tr>
                        <tr>
                            <th></th>
                            <th><?= __('S.No') ?></th>
