		...
		<div class="box-body pad-forty">
			<div class="row">
				<div class="large-12 columns">
					...
					<div class="tabs-content edumix-tab-horz">
						...
						<div class="content" id="education_background">
												...
												<tbody>
													...
													if (!empty($this->data['HighSchoolEducationBackground'])) {
														...
														<tr>
															...
															<td class="center"><div style="margin-top: 10px;"><?= $this->Form->input('HighSchoolEducationBackground.0.name', array('class' => "otherRequiredText-input", 'label' => false, 'style' => 'width:100%;', 'required', 'onBlur' => 'checkIsAlpha(this)', 'value' => (isset($this->data['HighSchoolEducationBackground'][0]['name']) && !empty($this->data['HighSchoolEducationBackground'][0]['name']) ? $this->data['HighSchoolEducationBackground'][0]['name'] : (isset($studentDetail['AcceptedStudent']['high_school']) && !empty($studentDetail['AcceptedStudent']['high_school']) ? (ucwords(strtolower(trim($studentDetail['AcceptedStudent']['high_school'])))) : '')))); ?></div></td>
															...
															<td class="center"><div style="margin-top: 10px;"><?= $this->Form->input('HighSchoolEducationBackground.0.zone', array('class' => "otherRequiredText-input", 'label' => false, 'type' => 'text', 'required', 'onBlur' => 'checkIsAlpha(this)', 'style' => 'width:100%;', 'value' => (isset($this->data['HighSchoolEducationBackground'][0]['zone']) && !empty($this->data['HighSchoolEducationBackground'][0]['zone']) ? $this->data['HighSchoolEducationBackground'][0]['zone'] : (isset($studentDetail['AcceptedStudent']['zone_id']) && !empty($studentDetail['AcceptedStudent']['zone_id']) ? $zones[$studentDetail['AcceptedStudent']['zone_id']] :  (isset($studentDetail['Student']['zone_id']) && !empty($studentDetail['Student']['zone_id']) ? $zones[$studentDetail['Student']['zone_id']] : ''))))); ?></div></td>
													...
													if (!empty($this->data['HigherEducationBackground'])) {
														...
														foreach ($this->data['HigherEducationBackground'] as $bk => $bv) {
															...
															<tr>
																...
																<td class="center"><div style="margin-top: 10px;"><?= $this->Form->input('HigherEducationBackground.' . $bk . '.cgpa_at_graduation', array('class' => "cgpa-input", 'required', 'label' => false, 'placeholder' => 'CGPA', 'type' => 'text', 'onBlur' => 'checkCGPA(this)' /* 'min' => '2.00', 'max' => '4.00', 'step' => '0.01', */)); ?></div></td>
														...
														<tr>
															...
															<td class="center"><div style="margin-top: 10px;"><?= $this->Form->input('HigherEducationBackground.0.cgpa_at_graduation', array('class' => "cgpa-input", 'required', 'label' => false, 'placeholder' => 'CGPA', 'type' => 'text', 'onBlur' => 'checkCGPA(this)' /* 'min' => '2.00', 'max' => '4.00', 'step' => '0.01', */)); ?></div></td>
							...
							<div class="row">
								...
								if ((/* $ethiopianStudent &&  */$this->Session->read('Auth.User')['role_id'] == ROLE_REGISTRAR && ($studentDetail['Program']['id'] == PROGRAM_UNDEGRADUATE)) || (isset($this->data['EheeceResult'][0]['subject']) && !empty($this->data['EheeceResult'][0]['subject']))) { 
												...
												<tbody>
													...
													if (!empty($this->data['EheeceResult'])) {
														...
														foreach ($this->data['EheeceResult'] as $bk => $bv) {
															...
															<tr>
																<td class="center"><?= ++$count; ?></td>
																<td class="center"><div style="margin-top: 10px;"><?= $this->Form->input('EheeceResult.' . $bk . '.subject', array('required', 'class' => "subject-input", 'name' => "data[EheeceResult][$bk][subject]", 'value' => (isset($this->data['EheeceResult'][$bk]['subject']) ? $this->data['EheeceResult'][$bk]['subject'] : ''), /* 'pattern' => 'alpha', */ 'onBlur' => 'checkIsAlpha(this)', 'placeholder' => 'Subject 1',  'style' => 'width:100%;',  'label' => false)); ?></div></td>
																<td class="center"><div style="margin-top: 10px;"><?= $this->Form->input('EheeceResult.' . $bk . '.mark', array('class' => "subjectMark-input", 'required', 'onBlur' => 'checkValidMarkInput(this)', 'name' => "data[EheeceResult][$bk][mark]", 'value' => (isset($this->data['EheeceResult'][$bk]['mark']) ? $this->data['EheeceResult'][$bk]['mark'] : ''),  'placeholder' => 'Mark 1', 'style' => 'width:100%;', 'label' => false, 'min' => '0', 'max' => '100', 'step' => 'any')); ?></div></td>
					...
					<?= ($this->Session->read('Auth.User')['role_id'] == ROLE_REGISTRAR ? $this->Form->end(array('label' => 'Update Student Detail', /* 'disabled', */ 'name' => 'updateStudentDetail', 'id' => 'updateStudentDetail', 'class' => 'tiny radius button bg-blue')) : ''); ?>
