<div class="box">
	<div class="box-header bg-transparent">
		<div class="box-title" style="margin-top: 10px;"><i class="fontello-vcard" style="font-size: larger; font-weight: bold;"></i>
			<span style="font-size: medium; font-weight: bold; margin-top: 20px;"> <?= __('Student Preference List'); ?> :
                <?= $studentBasic['full_name'] . ' (' .
                $studentBasic['studentnumber'] . ')'; ?></span>
		</div>
								...
								<tbody>
									...
									foreach ($studentsPreference as $k => $v) { ?>
										<tr>
											...
											<td style="text-align: center;"><?= $v['preferences_order']; ?></td>
										</tr>
										<?php
									} ?>
								</tbody>
