...
class InstructorNumberOfExamConstraintsController extends AppController
{
    ...
    public $name = 'InstructorNumberOfExamConstraints';
    ...
    public function add()
    {
        ...
        $departments = $this->InstructorNumberOfExamConstraint->Staff->Department->find(
            'list',
        ...
        if (!empty($this->request->data) && isset($this->request->data['search'])) {
            ...
            switch ($this->request->data) {
                case empty($this->request->data['InstructorNumberOfExamConstraint']['academicyear']) :
                    $this->Session->setFlash(
                        '<span></span> ' . __(
                            'Please select the academic year of the exam period that you want to add instructor number of exam constraints.'
                        ),
                        'default',
                ...
                case empty($this->request->data['InstructorNumberOfExamConstraint']['department_id']) :
                    $this->Session->setFlash(
                        '<span></span> ' . __(
                            'Please select the department of the exam period that you want to add instructor number of exam constraints. '
                        ),
                        'default',
                        array('class' => 'error-box error-message')
                    );
                ...
                case empty($this->request->data['InstructorNumberOfExamConstraint']['semester']) :
                    $this->Session->setFlash(
                        '<span></span> ' . __(
                            'Please select the semester of the exam period that you want to add instructor enumber of exam constraints. '
                        ),
                        'default',
                        array('class' => 'error-box error-message')
                    );
            ...
            if ($everythingfine) {
                ...
                $instructors_list = $this->_get_instructors_list(
                    $selected_department,
                ...
                if (empty($instructors_list)) {
                    $this->Session->setFlash(
                        '<span></span> ' . __(
                            'There is no instructor to add  instructor number of exam constraints in the selected criteria.'
                        ),
                        'default',
                    ...
                    $this->set(
                        compact('instructors_list', 'selected_academicyear', 'selected_department', 'selected_semester')
                    );
                }
            }
        }
        if (!empty($this->request->data) && isset($this->request->data['submit'])) {
            ...
            if (!empty($selected_max_number_of_exam)) {
                ...
                if (!empty($year_level_count)) {
                    $is_already_recorded = $this->InstructorNumberOfExamConstraint->alreadyRecorded(
                        $this->college_id,
                        $selected_academicyear,
                        $selected_semester,
                        $selected_year_level,
                    ...
                    if ($is_already_recorded == false) {
                        ...
                        if ($this->InstructorNumberOfExamConstraint->saveAll(
                            $instructor_number_of_exams['InstructorNumberOfExamConstraint'],
                        ...
                        if ($is_saved == true) {
                            $this->Session->setFlash(
                                '<span></span>' . __('The instructor number of exam constraint has been saved.'),
                                'default',
                            ...
                            $this->Session->setFlash(
                                '<span></span>' . __(
                                    'The instructor number of exam constraint could not be saved. Please, try again.'
                                ),
                                'default',
                                array('class' => 'error-box error-message')
                            );
                        ...
                        if (isset($error['already_recorded_instructor_number_of_exam'])) {
                            $this->Session->setFlash(
                                '<span></span>' . __(
                                    $error['already_recorded_instructor_number_of_exam'][0] . ', please exclude this year level from you selection or delete the record of this year level.'
                                ),
                                'default',
                                array('class' => 'error-box error-message')
                            );
                    ...
                    $this->Session->setFlash(
                        '<span></span>' . __('Please select year level.'),
                        'default',
                        array('class' => 'error-box error-message')
                    );
                }
                ...
                $this->Session->setFlash(
                    '<span></span>' . __('Please provide maximum number of exam.'),
                    'default',
                    array('class' => 'error-box error-message')
                );
            }
            ...
            $instructorNumberOfExamConstraints = $this->_get_already_recorded_instructor_number_of_exam_constraints(
                $selected_instructor_id,
                $selected_academicyear,
                $selected_semester,
                $selected_department
    ...
    public function edit($id = null)
    {
        ...
        if (!empty($this->request->data)) {
            if ($this->InstructorNumberOfExamConstraint->save($this->request->data)) {
                ...
                $this->Session->setFlash(
                    __('The instructor number of exam constraint could not be saved. Please, try again.')
                );
            }
        }
        if (empty($this->request->data)) {
    ...
    public function delete($id = null, $from = null)
    {
        ...
        if (!$id) {
            $this->Session->setFlash(
                '<span></span> ' . __('Invalid id for instructor number of exam constraint.'),
                'default',
                array('class' => 'error-box error-message')
            );
            if (empty($from)) {
        ...
        $deleted_instructor_number_of_exam_constraint_data = $this->InstructorNumberOfExamConstraint->find(
            'first',
            array('conditions' => array('InstructorNumberOfExamConstraint.id' => $id), 'recursive' => -1)
        );
        $this->Session->write(
            'selected_academicyear',
            $deleted_instructor_number_of_exam_constraint_data['InstructorNumberOfExamConstraint']['academic_year']
        );
        $this->Session->write(
            'selected_semester',
            $deleted_instructor_number_of_exam_constraint_data['InstructorNumberOfExamConstraint']['semester']
        );
        if (!empty($deleted_instructor_number_of_exam_constraint_data['InstructorNumberOfExamConstraint']['staff_id'])) {
            ...
            $selected_department = $this->InstructorNumberOfExamConstraint->Staff->field(
                'Staff.department_id',
                array('Staff.id' => $selected_instructor_id)
            );
            $this->Session->write('selected_department', $selected_department);
        } else {
            if (!empty($deleted_instructor_number_of_exam_constraint_data['InstructorNumberOfExamConstraint']['staff_for_exam_id'])) {
        ...
        if ($this->InstructorNumberOfExamConstraint->delete($id)) {
            $this->Session->setFlash(
                '<span></span> ' . __('Instructor number of exam constraint deleted'),
                'default',
                array('class' => 'success-box success-message')
            );
            if (empty($from)) {
        ...
        $this->Session->setFlash(
            '<span></span> ' . __('Instructor number of exam constraint was not deleted.'),
            'default',
            array('class' => 'error-box error-message')
        );
        if (empty($from)) {
    ...
    public function _get_instructors_list($department_id = null, $academicyear = null, $semester = null)
    {

        if ($department_id == 10000) {
            $instructors_list = $this->InstructorNumberOfExamConstraint->StaffForExam->find(
                'all',
                array(
                    'conditions' => array(
            ...
            $instructors_list = $this->InstructorNumberOfExamConstraint->Staff->find(
                'all',
                array(
                    'conditions' => array(
    ...
    public function get_instructor_number_of_exam_constraints_details($data = null)
    {
        ...
        if (!empty($explode_data[0])) {
            ...
            $yearLevels = $this->InstructorNumberOfExamConstraint->get_maximum_year_levels_of_college(
                $this->college_id
            );
            $instructorNumberOfExamConstraints = $this->_get_already_recorded_instructor_number_of_exam_constraints(
                $instructor_id,
    ...
    public function _get_already_recorded_instructor_number_of_exam_constraints(
        $instructor_id = null,
        $academicyear = null,
        $semester = null,
        $department_id = null
        ...
        if ($department_id == 10000) {
            $instructorNumberOfExamConstraints = $this->InstructorNumberOfExamConstraint->find(
                'all',
                array(
                    'conditions' => array(
                        'InstructorNumberOfExamConstraint.academic_year' => $academicyear,
                        'InstructorNumberOfExamConstraint.semester' => $semester,
                        'InstructorNumberOfExamConstraint.staff_for_exam_id' => $instructor_id
                    ),
                    'contain' => array(
                        'StaffForExam' => array(
                            'Staff' => array(
            ...
            $instructorNumberOfExamConstraints = $this->InstructorNumberOfExamConstraint->find(
                ...
                array(
                    'conditions' => array(
                        'InstructorNumberOfExamConstraint.academic_year' => $academicyear,
                        'InstructorNumberOfExamConstraint.semester' => $semester,
                        'InstructorNumberOfExamConstraint.staff_id' => $instructor_id
                    ),
                    'contain' => array(
                        'Staff' => array(
                            'fields' => array('Staff.id', 'Staff.full_name'),
