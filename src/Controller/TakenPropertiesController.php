...
class TakenPropertiesController extends AppController
{
    ...
    public function index()
    {
        ...
        if ($this->role_id == ROLE_COLLEGE) {
            $departments = $this->TakenProperty->Student->Department->find(
                'list',
        ...
        } elseif ($this->role_id == ROLE_CLEARANCE || $this->role_id == ROLE_ACCOMODATION) {
            $colleges = $this->TakenProperty->Student->College->find('list');
            $departments = $this->TakenProperty->Student->Department->find('list');
            $offices = $this->TakenProperty->Office->find('list', array(
                'conditions' => array(
            ...
            if (!empty($this->request->data['Search']['department_id'])) {
                if ($this->role_id == ROLE_COLLEGE) {
                    ...
                    if ($this->role_id == ROLE_CLEARANCE || $this->role_id == ROLE_ACCOMODATION) {
                        $find_office_id = $this->TakenProperty->Office->field(
                            'id',
    ...
    public function add()
    {
        ...
        if (!empty($this->request->data) && isset($this->request->data['saveTakenProperties'])) {
            ...
            if ($this->TakenProperty->saveAll($this->request->data['TakenProperty'], array('validate' => 'first'))) {
                $this->Session->setFlash(
                    '<span></span>' . __('The taken property has been saved'),
                    'default',
                ...
                $this->Session->setFlash(
                    '<span></span>' . __('The taken property could not be saved. Please, try again.'),
                    'default',
                    array('class' => 'error-box error-message')
                );

                $this->request->data['continue'] = true;
                $student_number = $this->TakenProperty->Student->field(
                    'studentnumber',
        ...
        if (!empty($this->request->data) && isset($this->request->data['continue'])) {
            ...
            if (!empty($this->request->data['Search']['studentID'])) {
                ...
                if ($check_id_is_valid > 0) {
                    $everythingfine = true;
                    $student_id = $this->TakenProperty->Student->field(
                        'id',
                ...
                $this->Session->setFlash(
                    '<span></span> ' . __('Please provide student number to maintain taken properties.'),
                    'default',
                    array('class' => 'error-box error-message')
                );
            }
        ...
        if (!empty($this->request->data) && isset($this->request->data['saveTakenProperties'])) {
            ...
            if ($this->TakenProperty->save($this->request->data)) {
                ...
                if (!empty($this->request->data['TakenProperty']['student_id'])) {
                    $student_section_exam_status = $this->TakenProperty->Student->get_student_section(
                        $this->request->data['TakenProperty']['student_id']
                    );
                }
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if (!$id) {
            $this->Session->setFlash(
                '<span></span>' . __('Invalid id for taken property'),
                'default',
                array('class' => 'error-box error-message')
            );
            return $this->redirect(array('action' => 'index'));
        ...
        if ($this->TakenProperty->delete($id)) {
            $this->Session->setFlash(
                '<span></span>' . __('Taken property deleted'),
                'default',
                array('class' => 'success-box success-message')
            );
            return $this->redirect(array('action' => 'index'));
        ...
        $this->Session->setFlash(
            '<span></span>' . __('Taken property was not deleted'),
            'default',
            array('class' => 'error-box error-message')
        );
        return $this->redirect(array('action' => 'index'));
    ...
    public function returned_property()
    {
        ...
        if (!empty($this->request->data) && isset($this->request->data['update'])) {
            if ($this->TakenProperty->saveAll(
                $this->request->data['TakenProperty'],
