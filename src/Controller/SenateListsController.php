	...
	***/
	...
	function add($department_id = null, $program_id = null, $program_type_id = null)
	{
		...
		if (!empty($this->request->data) && !empty($this->request->data['listStudentsForSenateList'])) {
			...
			$students_for_senate_list = $this->SenateList->getListOfStudentsForSenateList($this->request->data['SenateList']['program_id'], $this->request->data['SenateList']['program_type_id'], $this->request->data['SenateList']['department_id'], $this->request->data['SenateList']['academicyear'],  $this->request->data['SenateList']['percent_completed'], $this->request->data['SenateList']['studentnumber']);
