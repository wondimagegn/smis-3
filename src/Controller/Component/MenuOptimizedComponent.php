...
class MenuOptimizedComponent extends Component
{
	...
	public function initialize(Controller $Controller)
	{
		...
		if ($this->Auth->user('id')) {
			...
			//student save the cache of the role not user 
	...
	public function startup(Controller $Controller)
	{
		...
		Cache::config($this->cacheConfig, array(
			'engine' => 'File', 'duration' => $this->cacheTime,
	...
	{
		$data = array('menus' => $this->rawMenus);
			...
			foreach ($Controllers as $ctrlName => $actions) {
				...
				if (!empty($methods)) {
					foreach ($methods as $action) {
						...
						$url = array('controller' => $ctrlCamel, 'action' => $action);
	...
	public function setOptions($controllerVars)
	{
		...
		$exclude = array('view', 'edit', 'delete', $cakeAdmin . '_edit', $cakeAdmin . '_delete', $cakeAdmin . '_edit', $cakeAdmin . '_view');
