...
class MenuOptimizedComponent extends Component
{
    ...
    public function startup()
    {
        ...
        $this->menu = $this->addMenu([
            ...
            'parent' => 'examSchedule',
            'url' => ['controller' => 'ExamSchedules', 'action' => 'collegeExamScheduleView']
        ]);
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                ...
                'action' => 'collegeExamScheduleView',
            )
        ));
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                'controller' => 'students',
                'action' => 'departmentIssuePassword',
            )
        ));
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                'controller' => 'courseSchedules',
                'action' => 'cancelAutoGeneratedSchedule',
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                'controller' => 'students',
                'action' => 'manageStudentMedicalCardNumber',
            ),
        ));
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                ...
                'action' => 'departmentMakeupExamResult',
            ),
        ));
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                'controller' => 'examGradeChanges',
                'action' => 'manageDepartmentGradeChange',
            ),
        ));
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                'controller' => 'examGradeChanges',
                'action' => 'manageCollegeGradeChange',
            ),
        ));
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                'controller' => 'examGradeChanges',
                'action' => 'manageRegistrarGradeChange',
            ),
        ));
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                'controller' => 'examGradeChanges',
                'action' => 'freshmanMakeupExamResult',
            ),
        ));
        ...
        $this->menu = $this->addMenu(array(
            ...
            'url' => array(
                'controller' => 'examGradeChanges',
                'action' => 'manageFreshmanGradeChange',
            ),
        ));
    ...
    public function check($aro, $aco, $action = "*")
    {
        ...
        return isset($permissionLists) && !empty($permissionLists)
            && in_array($aco, $permissionLists);
    }
