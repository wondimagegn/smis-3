    ...
    public function create($name, $type)
    {
        ...
        switch ($type) {
            ...
            case 'areaspline':
                App::import(
                    'Vendor',
                    'Highcharts.HighRollerAreasplineChart',
                    true,
                    array(),
                    'HighRollerAreaSplineChart.php'
                );
            ...
            case 'waterfall':
                App::import(
                    'Vendor',
                    'Highcharts.HighRollerWaterfallChart',
                    true,
                    array(),
                    'HighRollerWaterfallChart.php'
                );
            ...
            case 'columnrange':
                App::import(
                    'Vendor',
                    'Highcharts.HighRollerColumnrangeChart',
                    true,
                    array(),
                    'HighRollerColumnrangeChart.php'
                );
 ...
 */
    public function setChartParams($name, $params = array())
    {
        ...
        if (isset($params['plotOptionsPieDataLabelsFormat'])) {
            $this->charts[$name]->plotOptions->pie = new HighRollerPlotOptionsByChartType(
                $this->charts[$name]->chart->type
            );
