    ...
    public function add()
    {
        ...
        if (!empty($this->request->data)) {
            ...
            if (!empty($yearLevels['YearLevel'])) {
                ...
                $this->Flash->error(
                    'The year level could not be saved. There are already ' . $maximum_year_level . ' year levels in your department.'
                );
            }
        }
        ...
        if ($this->role_id == ROLE_COLLEGE) {
            ...
            if ($this->role_id == ROLE_DEPARTMENT) {
                ...
                $departments = $this->YearLevel->Department->find(
                    'list',
                    array('conditions' => array('Department.id' => $this->department_id))
                );

                $already_created_year_levels_count = $this->YearLevel->find(
                    'count',
