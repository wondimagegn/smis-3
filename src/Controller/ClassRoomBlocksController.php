...
class ClassRoomBlocksController extends AppController
{
    ...
    public function index($id = null)
    {
        ...
        if (ROLE_COLLEGE == $this->role_id) {
            ...
            $thiscollege = $this->ClassRoomBlock->College->Department->field(
                'Department.college_id',
                array('Department.id' => $this->department_id)
            );
        }
        if ($id) {
            $programProgramTypes = $this->ClassRoomBlock->ClassRoom->ProgramProgramTypeClassRoom->find(
                'all',
                array(
                    'conditions' => array('ProgramProgramTypeClassRoom.class_room_id' => $id),
                    'contain' => array(
                        'ClassRoom' => array('fields' => array('ClassRoom.room_code')),
            ...
            if (!empty($programProgramTypes)) {
                ...
                $classroomname = $this->ClassRoomBlock->ClassRoom->field(
                    'ClassRoom.room_code',
                    array('ClassRoom.id' => $id)
                );
        ...
        $this->paginate = array(
            ...
            'contain' => array(
                ...
                'Campus' => array('fields' => array('Campus.id', 'Campus.name')),
                'ClassRoom'
            )
        );
    ...
    public function add()
    {
        ...
        if (!empty($this->request->data)) {
            ...
            $is_class_room_block_duplicated = $this->ClassRoomBlock->find(
                'count',
                array(
                    'conditions' => array(
                        'ClassRoomBlock.college_id' => $this->request->data['ClassRoomBlock']['college_id'],
                        'ClassRoomBlock.campus_id' => $this->request->data['ClassRoomBlock']['campus_id'],
                        'ClassRoomBlock.block_code' => $this->request->data['ClassRoomBlock']['block_code']
                    )
                )
            );
            if ($is_class_room_block_duplicated == 0) {
                ...
                if ($this->ClassRoomBlock->saveAll($this->request->data, array('validate' => 'first'))) {
                    $this->Session->setFlash(
                        '<span></span>' . __('The class room block has been saved'),
                        'default',
                    ...
                    $this->Session->setFlash(
                        '<span></span>' . __('The class room block could not be saved. Please, try again.'),
                        'default',
                ...
                $this->Session->setFlash(
                    '<span></span> The class room block available in this college and campus. Please, provide unique class room block or edit the class room block in ',
                    "session_flash_link",
                    array(
    ...
    public function edit($id = null)
    {
        ...
        if (!$id && empty($this->request->data)) {
            $this->Session->setFlash(
                '<span></span> ' . __('Invalid class room block'),
                'default',
                array('class' => 'error-box error-message')
            );
            return $this->redirect(array('action' => 'index'));
    ...
    public function delete($id = null)
    {
        ...
        if (!$id) {
            $this->Session->setFlash(
                '<span></span> ' . __('Invalid id for class room block'),
                'default',
                array('class' => 'error-box error-message')
            );
            return $this->redirect(array('action' => 'index'));
        ...
        $classroom_count = 0;
        $classroom_count = $this->ClassRoomBlock->ClassRoom->find('count', array(
            'conditions' =>
        ...
        if ($classroom_count == 0) {
            if ($this->ClassRoomBlock->delete($id)) {
                $this->Session->setFlash(
                    '<span></span> ' . __('Class room block deleted'),
                    'default',
                    array('class' => 'success-box success-message')
                );
                return $this->redirect(array('action' => 'index'));
            ...
            $this->Session->setFlash(
                '<span></span> ' . __(
                    'The Class room block can not be delete since it have ' . $classroom_count . ' class rooms under the block, Please delete the class room first.'
                ),
                'default',
                array(
        ...
        $this->Session->setFlash(
            '<span></span> ' . __('Class room block was not deleted'),
            'default',
            array('class' => 'error-box error-message')
        );
        return $this->redirect(array('action' => 'index'));
        ...
        if (!empty($this->request->data)) {
            if (!empty($this->request->data['ClassRoomBlock']['program_type_id'])) {
                ...
                if (count($selected_class_rooms_array) > 0) {
                    ...
                    $this->Session->setFlash(
                        '<span></span>' . __(
                            ' The class rooms has been assigned to selected program and program type.'
                        ),
                        'default',
                        array(
                            'class' => 'success-box success-message'
                    ...
                    $this->Session->setFlash(
                        '<span></span>' . __(' Please select at least 1 class rooms'),
                        'default',
                        array('class' => 'error-box error-message')
                    );
                }
            ...
            $merged_class_rooms_data = $this->_get_class_rooms_data(
                $this->request->data['ClassRoomBlock']['program_id'],
                $this->request->data['ClassRoomBlock']['program_type_id']
            );
            ...
            $this->set(
                compact(
                    'fromadd_organized_classRooms_blocks_data',
                    'fromadd_already_assign_class_rooms',
                    'seleted_program_type_id'
                )
            );
        }
        if ($this->Session->read('program_type_id')) {
    ...
    public function deleteAssignProgramProgramType($id = null)
    {
        ...
        if (!$id) {
            $this->Session->setFlash(
                '<span></span> ' . __('Invalid id for program program type class room'),
                'default',
                array('class' => 'error-box error-message')
            );
        ...
        $program_id = $this->ClassRoomBlock->ClassRoom->ProgramProgramTypeClassRoom->field(
            'ProgramProgramTypeClassRoom.program_id',
            array('ProgramProgramTypeClassRoom.id' => $id)
        );
        $program_type_id = $this->ClassRoomBlock->ClassRoom->ProgramProgramTypeClassRoom->field(
            'ProgramProgramTypeClassRoom.program_type_id',
            array('ProgramProgramTypeClassRoom.id' => $id)
        );
        ...
        if ($this->ClassRoomBlock->ClassRoom->ProgramProgramTypeClassRoom->delete($id)) {
            $this->Session->setFlash(
                '<span></span> ' . __('Program program type class room deleted'),
                'default',
                array('class' => 'success-box success-message')
            );
            return $this->redirect(array('action' => 'assign_program_program_type'));
        ...
        $this->Session->setFlash(
            '<span></span> ' . __('Program program type class room was not deleted'),
            'default',
            array('class' => 'error-box error-message')
        );
        return $this->redirect(array('action' => 'assign_program_program_type'));
    ...
    public function _get_class_rooms_data($program_id = null, $program_type_id)
    {

        //to get this college class rooms
        $class_room_id_array = array();
        $classroomblocks = $this->ClassRoomBlock->find(
            'all',
            array(
                'fields' => array('ClassRoomBlock.id'),
                'conditions' => array('ClassRoomBlock.college_id' => $this->college_id),
                'contain' => array('ClassRoom' => array('fields' => array('ClassRoom.id')))
            )
        );
        ...
        $already_assign_class_rooms = $this->ClassRoomBlock->ClassRoom->ProgramProgramTypeClassRoom->find(
            'all',
            array(
                'conditions' => array(
                    'ProgramProgramTypeClassRoom.class_room_id' => $class_room_id_array,
                    'ProgramProgramTypeClassRoom.program_id' => $program_id,
                    'ProgramProgramTypeClassRoom.program_type_id' => $program_type_id
                ),
                'contain' => array(
                    'ClassRoom' => array(
                        'fields' => array('ClassRoom.id', 'ClassRoom.room_code'),
        ...
        $classRooms_blocks_data = $this->ClassRoomBlock->find(
            'all',
            array(
                ...
                'contain' => array(
                    'Campus' => array('fields' => array('Campus.name')),
                    'ClassRoom' => array('fields' => array('ClassRoom.id', 'ClassRoom.room_code'))
                )
            )
        );
    ...
    public function _get_class_room_block($campus_id = null)
    {

        if (!empty($campus_id)) {
            $campus_classRoomBlocks = $this->ClassRoomBlock->find(
                'list',
                array(
                    'fields' => array('ClassRoomBlock.block_code', 'ClassRoomBlock.block_code'),
                    'conditions' => array(
                        'ClassRoomBlock.campus_id' => $campus_id,
    ...
    public function getClassRoomBlockExamRooms($class_room_block_id = null)
    {
        ...
        if (!empty($class_room_block_id)) {
            $classRooms = $this->ClassRoomBlock->ClassRoom->find(
                'list',
                array(
                    'conditions' =>
                        array(
