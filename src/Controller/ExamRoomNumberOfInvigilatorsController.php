...
class ExamRoomNumberOfInvigilatorsController extends AppController
{
    ...
    public $name = 'ExamRoomNumberOfInvigilators';
    ...
    public function index()
    {
        ...
        $classRoomBlocks = $this->ExamRoomNumberOfInvigilator->ClassRoom->ClassRoomBlock->find(
            'all',
            array(
        ...
        if (!empty($selected_class_room_block)) {
            $classRooms = $this->ExamRoomNumberOfInvigilator->ClassRoom->find(
                'list',
                array(
        ...
        $this->set(
            compact('formatted_class_room_blocks', 'classRooms', 'selected_class_room', 'selected_class_room_block')
        );
    }
    ...
    public function add()
    {
        ...
        if (!empty($this->request->data) && isset($this->request->data['submit'])) {
            ...
            $is_already_recorded = $this->ExamRoomNumberOfInvigilator->find(
                'count',
                array(
                    'conditions' => array(
                        'ExamRoomNumberOfInvigilator.class_room_id' => $selected_class_room,
                        'ExamRoomNumberOfInvigilator.academic_year' => $selected_academicyear,
                        'ExamRoomNumberOfInvigilator.semester' => $selected_semester
                    )
                )
            );
            if ($is_already_recorded == 0) {
                ...
                if (!empty($number_of_invigilator)) {
                    ...
                    if ($this->ExamRoomNumberOfInvigilator->save(
                        $this->request->data['ExamRoomNumberOfInvigilators']
                    )) {
                        $this->Session->setFlash(
                            '<span></span>' . __('The exam room number of invigilator has been saved.'),
                            'default',
                        ...
                        $this->Session->setFlash(
                            '<span></span>' . __(
                                'The exam room number of invigilator could not be saved. Please, try again.'
                            ),
                            'default',
                    ...
                    $this->Session->setFlash(
                        '<span></span>' . __('Please provide number of invigilator.'),
                        'default',
                        array('class' => 'error-box error-message')
                    );
                }
                ...
                $this->Session->setFlash(
                    '<span></span>' . __('You already have this record.'),
                    'default',
                    array('class' => 'error-box error-message')
                );
            }
        ...
        if (!empty($selected_class_room) && !empty($selected_academicyear) && !empty($selected_semester)) {
            $already_recorded_exam_room_number_of_invigilators = $this->_get_already_record(
                $selected_class_room,
        ...
        $this->set(
            compact(
                ...
                'selected_class_room',
                'already_recorded_exam_room_number_of_invigilators'
            )
        );
        ...
        if ($this->Session->read('from_delete')) {
            ...
            if ($this->Session->read('from_edit')) {
    ...
    public function edit($id = null)
    {
        ...
        if (!$id && empty($this->request->data)) {
            $this->Session->setFlash(
                '<span></span> ' . __('Invalid exam room number of invigilator.'),
                'default',
                array('class' => 'error-box error-message')
            );
        ...
        if (!empty($this->request->data)) {
            ...
            if ($this->ExamRoomNumberOfInvigilator->save($this->request->data)) {
                ...
                $this->Session->setFlash(
                    '<span></span> ' . __('The exam room number of invigilator could not be saved. Please, try again.'),
                    'default',
                    array('class' => 'success-box success-message')
                );
            }
    ...
    public function delete($id = null, $from = null)
    {
        ...
        if (!$id) {
            $this->Session->setFlash(
                '<span></span> ' . __('Invalid id for exam room number of invigilator.'),
                'default',
                array('class' => 'error-box error-message')
            );
            if (empty($from)) {
        ...
        if ($this->ExamRoomNumberOfInvigilator->delete($id)) {
            $this->Session->setFlash(
                '<span></span> ' . __('Exam room number of invigilator deleted'),
                'default',
                array('class' => 'success-box success-message')
            );
            if (empty($from)) {
        ...
        $this->Session->setFlash(
            '<span></span> ' . __('Exam room number of invigilator was not deleted.'),
            'default',
            array('class' => 'error-box error-message')
        );
        if (empty($from)) {
    ...
    public function get_already_recorded_exam_room_number_of_invigilator($data = null)
    {
        ...
        if (!empty($class_room_id)) {
            ...
            $selected_class_room_block = $this->ExamRoomNumberOfInvigilator->ClassRoom->field(
    ...
    public function _get_already_record($class_room_id = null, $academicyear = null, $semester)
    {

        $already_recorded_exam_room_number_of_invigilators = $this->ExamRoomNumberOfInvigilator->find(
            'all',
            array(
                'conditions' => array(
                    'ExamRoomNumberOfInvigilator.class_room_id' => $class_room_id,
                    'ExamRoomNumberOfInvigilator.academic_year' => $academicyear,
