...
class PublishedCoursesController extends AppController
{
    ...
    public function index(
        ...
        if ($this->Session->check('search_data_published_course')) {
            ...
            $academic_year = (!empty($this->request->data['PublishedCourse']['academic_year']) ? $this->request->data['PublishedCourse']['academic_year'] : $this->AcademicYear->current_acy_and_semester(
            )['academic_year']);
            $semester = (!empty($this->request->data['PublishedCourse']['semester']) ? $this->request->data['PublishedCourse']['semester'] : $this->AcademicYear->current_acy_and_semester(
            )['semester']);
        ...
        if (!empty($this->request->data['PublishedCourse']['program_id'])) {
            ...
            if (empty($selected_program_id)) {
                if (!empty($this->program_ids)) {
                    ...
                    $programss = ClassRegistry::init('Program')->find(
                        'list',
        ...
        if (!empty($this->request->data['PublishedCourse']['program_type_id'])) {
            ...
            if (empty($selected_program_type_id)) {
                if (!empty($this->program_type_ids)) {
                    ...
                    $program_typess = ClassRegistry::init('ProgramType')->find(
                        'list',
        ...
        if ($this->role_id == ROLE_COLLEGE || ($this->role_id == ROLE_REGISTRAR && $this->onlyPre && !empty($this->college_ids))) {
            ...
            if (!empty($this->request->data)) {
                ...
                if ($everythingfine) {
                    ...
                    $selected_program_id = (isset($this->request->data['PublishedCourse']['program_id']) && !empty($this->request->data['PublishedCourse']['program_id']) ? $this->request->data['PublishedCourse']['program_id'] : (isset($this->program_ids) ? array_values(
                        $this->program_ids
                    )[0] : '1'));
                    $selected_program_type_id = (isset($this->request->data['PublishedCourse']['program_type_id']) && !empty($this->request->data['PublishedCourse']['program_type_id']) ? $this->request->data['PublishedCourse']['program_type_id'] : (isset($this->program_type_ids) ? array_values(
                            ...
                            if (!empty($checkempty)) {
                                ...
                                foreach ($checkempty as $chindex => $chevalue) {
                                    if ($chevalue['PublishedCourse']['add'] == 0 && $chevalue['PublishedCourse']['drop'] == 0) {
                                        ...
                                        if ($chevalue['PublishedCourse']['add'] == 1) {
                                            $tmpcopy['Mass Add'][] = $chevalue;
                                        } else {
                                            if ($chevalue['PublishedCourse']['drop'] == 1) {
                    ...
                    if (empty($publishedCourses)) {
                        ...
                        $this->Flash->info(
                            __(
                                'There is no published courses in the given search criteria. Please select different criteria.'
                            )
                        );
                    } else {
    ...
    public function add()
    {
        ...
        if (!empty($this->request->data) && isset($this->request->data['getsection'])) {
            ...
            switch ($this->request->data) {
                ...
                case empty($this->request->data['Curriculum']['semester']):
                    $this->Flash->error(
                        __('Please select the semester you want to publish courses. Please, try again.')
                    );
                    break;
                case empty($this->request->data['Course']['year_level_id']):
                    $this->Flash->error(
                        __('Please select the year level you want to publish courses. Please, try again.')
                    );
                    break;
                case empty($this->request->data['Curriculum']['program_id']):
                    $this->Flash->error(
                        __('Please select the program you want to publish courses. Please, try again.')
                    );
                    break;
                case empty($this->request->data['Curriculum']['program_type_id']):
                    $this->Flash->error(
                        __('Please select the program type you want to publish courses. Please, try again.')
                    );
                    break;
                default:
                    $everythingfine = true;
            ...
            if ($everythingfine) {
                ...
                if (empty($sections)) {
                    $this->Flash->info(
                        __('No section is found that needs courses publishing with the selected search criteria.')
                    );
                } else {
                                ...
                                if (!empty($cv['Student'])) {
                                    ...
                                    if (isset($cv['Student'][$max_courses_taken_index_student]['CourseRegistration']) && !empty($cv['Student'][$max_courses_taken_index_student]['CourseRegistration'])) {
                                        foreach ($cv['Student'][$max_courses_taken_index_student]['CourseRegistration'] as $kk => $course_ids) {
                                            debug($course_ids);
                                            if ($this->PublishedCourse->Course->isCourseTakenHaveRecentPassGrade(
                                                $course_ids['student_id'],
                                                $course_ids['PublishedCourse']['course_id']
                                            )) {
        ...
        if (!empty($this->request->data) && isset($this->request->data['publishselectedasadd'])) {
                        ...
                        if ($is_selected != 0) {
                            if ($pcourses_count) {
                                ...
                                if (empty($no_previous_published_courses_error)) {
                                    $no_previous_published_courses_error = $this->PublishedCourse->Section->field(
                                            'name',
                                            array('Section.id' => $section_id)
                                        ) . ' section doesn\'t have any previous course publication for ' . (isset($this->request->data['PublishedCourse']['academic_year']) ? $this->request->data['PublishedCourse']['academic_year'] : $this->request->data['PublishedCourse']['academicyear']) . ' semster ' . $this->request->data['PublishedCourse']['semester'] . ', please use Publish Courses instead.';
                                }
                            }
                        }
                    }
                ...
                if (!empty($no_previous_published_courses_error)) {
                    ...
                    $this->redirect(
                        array(
                            ...
                            str_replace('/', '-', $this->request->data['PublishedCourse']['academic_year'])
                        )
                    );
                } else {
            ...
            if ($check_courses_published == count($courses_ids)) {
                ...
                $this->redirect(
                    array('action' => 'index', $this->request->data['PublishedCourse']['semester'], $academic_year)
                );
            }
            ...
            if (!empty($save_reformated_published_courses['PublishedCourse'])) {
                if ($this->PublishedCourse->saveAll(
                    ...
                    if ($count_already_published == 0) {
                        ...
                        $this->Flash->success(
                            __(
                                'Among selected courses, ' . $count_ready_published . ' course(s) published as mass add, ' . $count_already_published . ' courses were already published previously for the section.'
                            )
                        );
                    }
        ...
        if (!empty($this->request->data) && isset($this->request->data['publishselected'])) {
            ...
            if ($this->role_id == ROLE_DEPARTMENT) {
                if (isset($this->request->data['Section']['selected']) && !empty($this->request->data['Section']['selected'])) {
                    foreach ($this->request->data['Section']['selected'] as $sec_id => $sec_value) {
                        if ($sec_value != 0) {
                            $check_if_course_is_published_for_given_academic_year_semester = $this->PublishedCourse->find(
                                'count',
                                array(
                                    'conditions' => array(
                                        'PublishedCourse.academic_year' => $this->request->data['PublishedCourse']['academic_year'],
                                        'PublishedCourse.department_id' => $this->department_id,
                                        'PublishedCourse.semester' => $this->request->data['PublishedCourse']['semester'],
                                        'PublishedCourse.section_id' => $sec_id,
            ...
            if ($count == 0 || $upgrade_downgrade_section > 0) {
                ...
                if ($count == 0) {
                    ...
                    $this->Session->setFlash(
                        '<span></span>' . __(
                            'You can not publish semester ' . $this->request->data['PublishedCourse']['semester'] . ' of ' . $this->request->data['PublishedCourse']['academic_year'] . ' before publishing semester ' . $prev_semester_academic_year['semester'] . ' of ' . $prev_semester_academic_year['academic_year'] . ' for ' . $sections[$upgrade_downgrade_section] . '',
                            true
                        ),
                        "session_flash_link",
                        array(
                ...
                if ($check_registration_started == 0) {
                    ...
                    if (!empty($save_reformated_published_courses['PublishedCourse'])) {
                        if ($this->PublishedCourse->saveAll(
                            ...
                            $this->Flash->success(
                                __(
                                    count($save_reformated_published_courses['PublishedCourse']) . ' ' . (count(
                                        $save_reformated_published_courses['PublishedCourse']
                                    ) > 1 ? 'courses have' : 'course has') . ' been published for registration for ' . $this->request->data['PublishedCourse']['academic_year'] . ' academic year, semester: ' . $this->request->data['PublishedCourse']['semester'] . '.'
                                )
                            );

                            $academic_year = str_replace(
                                '/',
                                '-',
                                $this->request->data['PublishedCourse']['academic_year']
                            );
                            $this->Session->write(
                                'search_data_published_course',
                        ...
                        $this->Flash->error(
                            __('No new course is found to publish or update form the courses you selected.')
                        );
                        $academic_year = str_replace(
                            '/',
                            '-',
                    ...
                    $this->Flash->error(
                        __(
                            'You can not publish semester courses since registration has already started, but you can publish course as mass add.'
                        )
                    );
                    $academic_year = str_replace('/', '-', $this->request->data['PublishedCourse']['academic_year']);
                    $this->redirect(
            ...
            $this->set(
                'publishedcourses',
                $this->PublishedCourse->getSectionofPublishedCourses(
                    $this->request->data,
                    $this->department_id,
                    $publishedcourses
                )
        ...
        $yearLevelsInCurriculum = $this->PublishedCourse->Course->find(
            'list',
            array(
                'conditions' => array('Course.department_id' => $this->department_id),
        ...
        if (!empty($yearLevelsInCurriculum)) {
            ...
            $yearLevels = $this->PublishedCourse->YearLevel->find(
                'list',
                array('conditions' => array('YearLevel.id' => $yearLevelsInCurriculum))
            );
            debug($yearLevels);
    ...
    public function unpublish()
    {
        ...
        if (!empty($this->request->data) && isset($this->request->data['getsection'])) {
            ...
            switch ($this->request->data) {
                case empty($this->request->data['PublishedCourse']['academic_year']):
                    $this->Flash->error(
                        __('Please select the academic year you want to unpublish or publish as a drop course.')
                    );
                    break;
                case empty($this->request->data['PublishedCourse']['year_level_id']):
                    $this->Flash->error(
                        __('Please select the year level you want to unpublish or publish as a drop course.')
                    );
                    break;
                case empty($this->request->data['PublishedCourse']['semester']):
                    $this->Flash->error(
                        __('Please select the semester you want to unpublish or publish as a drop course.')
                    );
                    break;
                case empty($this->request->data['PublishedCourse']['program_id']):
                    $this->Flash->error(
                        __('Please select the program you want to unpublish or publish as a drop course..')
                    );
                    break;
                case empty($this->request->data['PublishedCourse']['program_type_id']):
                    $this->Flash->error(
                        __('Please select the program type you want to unpublish or publish as a drop course.')
                    );
                    break;
                default:
                    $everythingfine = true;
            ...
            if ($everythingfine) {
                ...
                if (empty($publishedcourses)) {
                    $this->Flash->info(
                        __('There is no published course in the given criteria, please select different criteria.')
                    );
                    // exit;
                } else {
                    $this->set('turn_off_search', true);
                ...
                if (count($courses_allowed_to_delete) > 0) {
                    ...
                    if (!empty($section_ids)) {
                        foreach ($section_ids as $key => $section_id) {
                            if (isset($courses_allowed_to_delete[$section_id])) {
                                if ($this->PublishedCourse->deleteAll(
                                    array('PublishedCourse.id' => $courses_allowed_to_delete[$section_id]),
                                    false
                                )) {
                    ...
                    if (!empty($count_delete_record)) {
                        ...
                        if ($sum > 0) {
                            $this->Flash->success(
                                __(
                                    'From the selected published course(s), you have unpublished/deleted ' . $sum . '  published course(s).'
                                )
                            );
                        } else {
                    ...
                    if (count($courses_not_allowed) > 0) {
                        $this->Flash->error(
                            __(
                                'You can not delete the red marked published course(s), students already registered for them. Please uncheck the red marked onees.'
                            )
                        );
                        $this->set(compact('courses_not_allowed'));
                    }
        ...
        if (!empty($this->request->data) && isset($this->request->data['dropselected'])) {
            ...
            if ($count == 0) {
                ...
                if (count($courses_not_allowed) > 0) {
                    $this->Flash->error(
                        __(
                            'There is no registration for the red marked course(s) so you can delete it permanently using "Delete Selected" option. you can also communicate the registrar or student to drop the selected courses.'
                        )
                    );
                    $this->set(compact('courses_not_allowed'));
                } else {
                    ...
                    if (!empty($section_ids)) {
                        ...
                        if (isset($save_reformat_drop_published_courses['PublishedCourse']) && count(
                            ...
                            if ($this->PublishedCourse->saveAll(
                                ...
                                $this->Flash->success(
                                    __('Among selected courses, ' . $count_drop . ' has been published as drop course.')
                                );
                                //$academic_year = str_replace('/', '-', $this->request->data['PublishedCourse']['academic_year']);
                                ...
                                $this->Flash->error(
                                    __(
                                        'Could not publish the selected published course(s) as mass drop. Please, try again.'
                                    )
                                );
                            }
                        } else {
                            $this->Flash->error(
                                __(
                                    'Internal Error occured while trying to publish the selected published course(s) as mass drop.'
                                )
                            );
                        }
                    }
        ...
        if (!empty($this->request->data) && isset($this->request->data['unpublishselected'])) {
            ...
            if ($count == 0) {
                ...
                if (count($courses_not_allowed) > 0) {
                    $this->Flash->error(
                        __(
                            'You can not unpublish the red marked courses, students have already registered for them. Please uncheck the red marked courses.'
                        )
                    );
                    $this->set(compact('courses_not_allowed'));
                } else {
                    ...
                    if ($this->PublishedCourse->saveAll(
                        ...
                        $this->Flash->error(
                            __('Could not unpublish the selected published course(s). Please, try again.')
                        );
                    }
                }
            }
        ...
        $programs = $this->PublishedCourse->Program->find(
            'list',
            array('conditions' => array('Program.id' => $this->program_ids, 'Program.active' => 1))
        );
        $program_types = $programTypes = $this->PublishedCourse->ProgramType->find(
            'list',
            array('conditions' => array('ProgramType.id' => $this->program_type_ids, 'ProgramType.active' => 1))
        );
    ...
    public function print_published_pdf()
    {
     ...
     * export to xls
     */
    public function export_published_xls()
    {
    ...
    public function __section_curriculum($sections = array(), $flag = null)
    {
                ...
                $array_list_sections = $this->PublishedCourse->Section->find('all', array(
                    ...
                    'contain' => array(
                        'Student' => array(
                            ...
                            'order' => array('Student.academicyear' => 'DESC'),
                            // to get the latest section Student Attached Curricullum first, Not readmitted ones, if there is one, Neway
                            'Section',
                            'Curriculum' => array(
                                'fields' => array(
    ...
    public function getPublishedCourses($data = null)
    {
    ...
    public function selectedPublishedCourses($data = null)
    {
        ...
        if ($this->Session->read('candidate_publish_courses')) {
            if ($data == 2) {
                ...
                $published_courses_disable_not_to_published = $this->Session->read(
    ...
    public function publisheForUnassigned($data = null)
    {
            ...
            $sections = $this->PublishedCourse->Section->find(
                ...
                array(
                    'conditions' => array(
                        ...
                        'Section.academicyear like ' => $this->request->data['PublishedCourse']['academic_year'] . '%'
                    )
                )
            );
    ...
    public function getPublishedCoursesForSplit($data = null)
    {
            ...
            if (!empty($this->request->data['Section']) and $this->request->data['SectionSplitForPublishedCourse']['selectedsection'] >= 0) {
                ...
                $list_of_courses = $this->PublishedCourse->find('all', array(
                    'conditions' => array(
                        'PublishedCourse.program_id' =>
                            $this->request->data['SectionSplitForPublishedCourse']['program_id'],
                        'PublishedCourse.semester' =>
                            $this->request->data['SectionSplitForPublishedCourse']['semester'],
                        'PublishedCourse.program_type_id' =>
                            $this->request->data['SectionSplitForPublishedCourse']['program_type_id'],
                        'PublishedCourse.year_level_id' =>
                            $this->request->data['SectionSplitForPublishedCourse']['year_level_id'],
                ...
                foreach ($list_of_courses as $lck => &$lcv) {
                    ...
                    if ($lcv['Course']['tutorial_hours'] > 0) {
                        ...
                        if ($lcv['Course']['laboratory_hours'] > 0) {
    ...
    public function getPublishedCoursesForExam($data = null)
    {
        ...
        if (!empty($this->request->data['Section'])) {
            ...
            if (count($selction_array) > 0) {
                ...
                $list_of_courses = $this->PublishedCourse->find(
                    ...
                    array(
                        'conditions' => array(
                            'PublishedCourse.program_id' => $this->request->data['MergedSectionsExam']['program_id'],
                            'PublishedCourse.semester' => $this->request->data['MergedSectionsExam']['semester'],
    ...
    public function getPublishedCoursesForExamForSplit($data = null)
    {
        ...
        if ($this->Session->read('list_of_courses') and $data == 2) {
            ...
            if (!empty($this->request->data['Section']) and $this->request->data['SectionSplitForExam']['selectedsection'] >= 0) {
                ...
                $list_of_courses = $this->PublishedCourse->find('all', array(
                    'conditions' => array(
                        'PublishedCourse.program_id' =>
                            $this->request->data['SectionSplitForExam']['program_id'],
                        'PublishedCourse.semester' =>
                            $this->request->data['SectionSplitForExam']['semester'],
                        'PublishedCourse.program_type_id' =>
                            $this->request->data['SectionSplitForExam']['program_type_id'],
        ...
        if (!empty($this->request->data) && isset($this->request->data['search'])) {
            ...
            switch ($this->request->data) {
                case empty($this->request->data['PublishedCourse']['academicyear']):
					...
					that you want to define courses number of session.',
                            true
                        ),
                        'default',
                ...
                case empty($this->request->data['PublishedCourse']['semester']):
                    $this->Session->setFlash(
                        '<span></span> ' . __(
                            'Please select the semester of the publish courses
					that you want to define courses number of session. ',
                            true
                        ),
                        'default',
            ...
            if ($everythingfine) {
                ...
                if (empty($sections_array)) {
                    $this->Session->setFlash(
                        '<span></span> ' . __(
                            'There is no published courses to define
					 number of session the selected criteria.',
                            true
                        ),
                        'default',
    ...
    public function get_course_type_session($publishedCourse_id = null)
    {
    ...
    public function attache_scale()
    {
        ...
        if (!empty($this->request->data) && isset($this->request->data['attachescaletocourse'])) {
            ...
            if (empty($data['PublishedCourse'])) {
                $this->Session->setFlash(
                    '<span></span>' . __('No course has been attached to any scale.'),
                    'default',
                    array('class' => 'info-box info-message')
                );
            } else {
                if ($this->PublishedCourse->saveAll(
                    ...
                    $this->Session->setFlash(
                        '<span></span>' . __('The grade scale could not be saved. Please, try again.'),
                        'default',
                        array('class' => 'error-box error-message')
                    );
                }
        ...
        if (!empty($this->request->data) && isset($this->request->data['getPublishedCourseList'])) {
            ...
            switch ($this->request->data) {
                case empty($this->request->data['PublishedCourse']['academic_year']):
                    $this->Session->setFlash(
                        '<span></span> ' . __('Please select the academic year you want to attach scale.'),
                        'default',
                        array('class' => 'error-box error-message')
                    );
                    break;
                ...
                case empty($this->request->data['PublishedCourse']['semester']):
                    $this->Session->setFlash(
                        '<span></span>' . __('Please select the semester you want to attache scale.'),
                        'default',
                        array('class' => 'error-box error-message')
                    );
                    break;
                ...
                case empty($this->request->data['PublishedCourse']['program_id']):
                    $this->Session->setFlash(
                        '<span></span>' . __('Please select the program you want to unpublished courses.'),
                        'default',
                        array('class' => 'error-box error-message')
                    );
                    break;
                case empty($this->request->data['PublishedCourse']['year_level_id']):
                    $this->Session->setFlash(
                        '<span></span>' . __('Please select the year level  you want  attache scale.'),
                        'default',
                        array('class' => 'error-box error-message')
                    );
                    break;
                ...
                if (!empty($publishedCourses)) {
                    ...
                    if (empty($gradeScales)) {
                        if (
                            ...
                            $this->Session->setFlash(
                                '<span></span>' . __(
                                    'There is no grade scale in the system that are defined, please define scale before attaching grade scale to published courses.'
                                ),
                                'default',
                                array('class' => 'error-box error-message')
                            );
                            ...
                            if (
                                ...
                                $this->Session->setFlash(
                                    '<span></span>' . __(
                                        'You dont have mandate to attach
			              grade scale to published courses,
			              grade scale defined by the college will be applicable to
			              the published courses, if this is not right please contact college to delegate scale to department.',
                                        true
                                    ),
                                    'default',
                                    array('class' => 'error-box error-message')
                    ...
                    $section_organized_published_courses = $this->PublishedCourse->get_section_organized_published_courses(
                        $this->request->data,
                        $this->department_id,
                        $publishedCourses
                    );

                    $section_organized_published_courses = $this->PublishedCourse->getSectionOrganizedPublishedCoursesM(
                        $publishedCourses
                    );
                    ...
                    if (empty($section_organized_published_courses)) {
                        $this->Session->setFlash(
                            '<span></span>' . __(
                                'There is no published courses in the given criteria that needs scale attachment.'
                            ),
                            'default',
                            array('class' => 'error-box error-message')
                        );
        ...
        if ($find_delegation_program_ids['College']['deligate_for_graduate_study'] == 1 && $find_delegation_program_ids['College']['deligate_scale'] == 1) {
            ...
            if (
                ...
                $programs = $this->PublishedCourse->Program->find('list', array(
                    'conditions' =>
    ...
    public function get_course_grade_scale($published_course_id = null)
    {
    ...
    public function get_course_grade_stats($published_course_id = null)
    {
        ...
        if (!empty($published_course_id)) {
            $gradeStatistics = $this->PublishedCourse->CourseRegistration->ExamGrade->getLetterGradeStatistics(
                $published_course_id
            );
        }
    ...
    public function get_course_published_for_section($section_id = "", $last = 1)
    {
    ...
    public function college_publish_course()
    {
        ...
        if (!empty($this->request->data) && isset($this->request->data['getsection'])) {
            ...
            switch ($this->request->data) {
                ...
                case empty($this->request->data['PublishedCourse']['department_id']):
                    $this->Flash->error(
                        __('Please select the department you want to to select curriculum to be published.')
                    );
                    break;
            ...
            if ($everythingfine) {
                ...
                if (empty($sections)) {
                    $this->Flash->info(
                        __('You need to create section before publish courses for pre-engineering/freshman students.')
                    );
        ...
        if (!empty($this->request->data) && isset($this->request->data['publishselectedadd'])) {
            ...
            if ($count == 0 || !empty($no_previous_published_courses_error)) {
                ...
                if ($check_courses_published == count($courses_ids)) {
                    $this->Flash->info(
                        __('The selected courses are already published for with the selected search criteria')
                    );
                    $academic_year = str_replace('/', '-', $this->request->data['PublishedCourse']['academic_year']);
                    $this->redirect(
                        array('action' => 'index', $this->request->data['PublishedCourse']['semester'], $academic_year)
                ...
                if (!empty($list_courses_published_ids)) {
                    $check_registration_started = $this->PublishedCourse->CourseRegistration->find(
                        'count',
                        array('conditions' => array('CourseRegistration.publish_course_id' => $list_courses_published_ids))
                    );
                    if ($check_registration_started == 0) {
                        $check_registration_started = $this->PublishedCourse->CourseAdd->find(
                            'count',
                ...
                if ($check_registration_started == 0) {
                    ...
                    $this->Flash->warning(
                        __(
                            'Course registration has been started. You can\'t publish the selected courses. You can publish them as mass add course instead.'
                        )
                    );
                    $academic_year = str_replace('/', '-', $this->request->data['PublishedCourse']['academic_year']);
                    $this->redirect(
        ...
        $programTypess = $this->PublishedCourse->Section->ProgramType->find(
            'list',
        ...
        if (count($this->college_ids) == 1 && $this->role_id == ROLE_COLLEGE && (in_array(
            ...
            $programs = $this->PublishedCourse->Section->Program->find(
                'list',
                array(
                    'conditions' => array(
                        'Program.id' => Configure::read('programs_available_for_registrar_college_level_permissions')
                    )
                )
            );
    ...
    public function college_unpublish_course()
    {
        ...
        if (!empty($this->request->data) && isset($this->request->data['getsection'])) {
            ...
            if ($everythingfine) {
                ...
                if (empty($publishedcourses)) {
                    $this->Flash->error(
                        'There is no published course(s) in the given criteria, Please select a different criteria.'
                    );
                } else {
                    $program_id = $this->request->data['PublishedCourse']['program_id'];
                    $program_type_id = $this->request->data['PublishedCourse']['program_type_id'];
        ...
        if (!empty($this->request->data) && isset($this->request->data['deleteselected'])) {
            ...
            if ($count == 0) {
                ...
                if (count($courses_not_allowed) > 0) {
                    $this->Flash->error(
                        'You can not delete the red marked course(s) , students already registered for the course(s). Please uncheck the red marked course(s).'
                    );
                    $this->set(compact('courses_not_allowed'));
                } else {
                    //$count_deleted_record=count($courses_allowed_to_delete);
                    ...
                    foreach ($section_ids as $key => $section_id) {
                        if (isset($courses_allowed_to_delete[$section_id])) {
                            if ($this->PublishedCourse->deleteAll(
                                array(
                                    'PublishedCourse.id' => $courses_allowed_to_delete[$section_id],
                                    'PublishedCourse.section_id' => $section_id
                                )
                            )) {
                                $count_delete_record[$section_id] = count($courses_allowed_to_delete[$section_id]);
        ...
        if (!empty($this->request->data) && isset($this->request->data['dropselected'])) {
            ...
            if ($count == 0) {
                ...
                if (count($courses_not_allowed) > 0) {
                    $this->Flash->error(
                        'You can not publish as drop courses of the red marked courses , no student has registred for it. Please check the red marked courses and press delete button at the bottom if you intend to  make it invisible for registration'
                    );
                    $this->set(compact('courses_not_allowed'));
                } else {
                    // reformat courses_allowed to unpublished
                    ...
                    if (!empty($section_ids)) {
                        ...
                        if (count($save_reformat_drop_published_courses['PublishedCourse']) > 0) {
                            if ($this->PublishedCourse->saveAll(
                                ...
                                $this->Flash->success(
                                    'Among selected  courses ' . $count_drop . ' has been published as drop course.'
                                );
                                // $academic_year = str_replace('/','-', $this->request->data['PublishedCourse']['academic_year']);
                                // $this->redirect(array('action' => 'index', $this->request->data['PublishedCourse']['semester'],$academic_year));
                            } else {
                                $this->Flash->error(
                                    'The course could not be published as drop coures. Please, try again.'
                                );
                            }
                        } else {
    ...
    public function college_attache_scale()
    {
        ...
        if (!empty($this->request->data) && isset($this->request->data['getPublishedCourseList'])) {
            ...
            if ($everythingfine) {
                ...
                if (!empty($publishedCourses)) {
                    if (strcasecmp(
                            $this->request->data['PublishedCourse']['department_id'],
                            'pre'
                        ) === 0 && $this->request->data['PublishedCourse']['program_id'] == PROGRAM_UNDEGRADUATE) {
                    ...
                    if (empty($gradeScales)) {
                        if ($find_delegation_program_ids['College']['deligate_for_graduate_study'] == 0 && $this->request->data['PublishedCourse']['program_id'] == PROGRAM_POST_GRADUATE) {
                            ...
                            if ($find_delegation_program_ids['College']['deligate_scale'] == 0 && PROGRAM_UNDEGRADUATE == $this->request->data['PublishedCourse']['program_id']) {
                                $this->Flash->error(
                                    'There is no grade scale in the system that are defined, please define scale before attaching grade scale to published courses.'
                                );
                                $this->redirect(array('controller' => 'gradeScales', 'action' => 'set_grade_scale'));
                                ...
                                if ($find_delegation_program_ids['College']['deligate_for_graduate_study'] == 1 && $this->request->data['PublishedCourse']['program_id'] == PROGRAM_POST_GRADUATE) {
                                    $this->Flash->error(
                                        'You have delegated attaching grade scale to department for postgraduate program.'
                                    );
                                }
                                if ($find_delegation_program_ids['College']['deligate_scale'] == 1 && $this->request->data['PublishedCourse']['program_id'] == PROGRAM_POST_GRADUATE) {
                                    $this->Flash->error(
                                        'You have delegated attaching grade scale to department for undergraduate program.'
                                    );
                                }
                            }
                        }
                    ...
                    $gradeScales = $return;
                    $section_organized_published_courses = $this->PublishedCourse->get_section_organized_published_courses_scale_attachment(
                        $this->request->data,
                        $this->request->data['PublishedCourse']['department_id'],
                        $publishedCourses,
                        $this->college_id
        ...
        if ($find_delegation_program_ids['College']['deligate_for_graduate_study'] == 0 && $find_delegation_program_ids['College']['deligate_scale'] == 0) {
            ...
            if ($find_delegation_program_ids['College']['deligate_for_graduate_study'] == 1 && $find_delegation_program_ids['College']['deligate_scale'] == 0) {
                $programs = $this->PublishedCourse->Program->find(
                    'list',
                    array('conditions' => array('Program.id' => PROGRAM_UNDEGRADUATE))
                );
