...
class ResultEntryAssignmentsTable extends Table
{
    public function initialize(array $config)
    {
        parent::initialize($config);

        $this->setTable('result_entry_assignments');
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ...
            ->numeric('student_id', 'Student ID must be a number.');
        ...
        $validator
            ...
            ->notEmptyString('published_course_id', 'Published Course ID is required.')
            ->numeric('published_course_id', 'Published Course ID must be a number.');
