...
class GeneralSettingsTable extends Table
{
    ...
    {
        $validator
            ->numeric('daysAvaiableForNgToF', 'Must be a numeric value.')
            ->numeric('daysAvaiableForDoToF', 'Must be a numeric value.')
            ->numeric('daysAvailableForFxToF', 'Must be a numeric value.')
            ->numeric('weekCountForAcademicYear', 'Must be a numeric value.')
            ->numeric('minimumCreditForStatus', 'Must be a numeric value.')
            ->boolean('allowMealWithoutCostsharing', 'Must be true or false.')
            ->boolean('notifyStudentsGradeByEmail', 'Must be true or false.')
            ->boolean('allowStudentsGradeViewWithouInstructorsEvalution', 'Must be true or false.');
