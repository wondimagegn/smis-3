...
class ClearancesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyDate('acceptance_date');

        $validator
            ->date('last_class_attended_date')
            ->allowEmptyDate('last_class_attended_date');
        ...
        $validator
            ->integer('forced_withdrawal')
            ->allowEmptyString('forced_withdrawal');

        $validator
            ->scalar('minute_number')
            ->maxLength('minute_number', 50)
