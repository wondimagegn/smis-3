...
class ColleagueEvalutionRatesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('colleague_evalution_rates');
    ...
    {
        $rules->add($rules->existsIn(['instructor_evalution_question_id'], 'InstructorEvalutionQuestions'));
        $rules->add($rules->existsIn(['staff_id'], 'Staffs'));
        $rules->add($rules->existsIn(['evaluator_id'], 'Evaluators'));
